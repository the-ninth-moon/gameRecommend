<template>
        ...
        <el-form :rules="rules" :model="loginForm" class="loginContainer" ref="loginForm">
            ...
            <el-button style="margin-left:20px;height:25px;" @click="navigateTo('/login/phoneLogin')">手机登录</el-button>
            <el-button style="margin-left:20px;height:25px;" @click="navigateTo('/login/resetPassWord')">忘记密码</el-button>
            <el-button style="margin-left:20px;height:25px;" @click="navigateTo('/login/register')">注册</el-button>
