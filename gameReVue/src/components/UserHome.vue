    ...
    <div>
        <el-container>
            ...
            <el-header class="homeHeader">
                <a href="/#/user/home"><div class="title">个人中心</div></a>
            ...
            <el-container>
                ...
                <el-main>
                    <!-- 面包屑 -->
                    <el-breadcrumb :separator-icon="ArrowRight" v-if="this.$router.currentRoute.path!='/user/home'">
                        <el-breadcrumb-item :to="{ path: '/user/home' }">首页</el-breadcrumb-item>
                        <el-breadcrumb-item >{{$route.name}}</el-breadcrumb-item>
                        <!-- <el-breadcrumb-item>{{this.$router.currentRoute.name}}</el-breadcrumb-item> -->
                    </el-breadcrumb>
                    <div class="homeWelcome" v-if="$route.path=='/user/home'">
                        <h1>游戏推荐系统</h1>
    ...
    export default {
        ...
        computed:{
            ...
            routeList(){
                ...
                return this.$router.options.routes.filter((_,index) => _.hidden===false ).filter((_,index) => _.path.charAt(1)=='u')
            },
        },
        methods:{
