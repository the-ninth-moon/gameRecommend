    ...
    <div>
        <el-container>
            ...
            <el-header class="homeHeader">
                <a href="/#/admin/home"><div class="title">管理员后台</div></a>
            ...
            <el-container>
                ...
                <el-main>
                    <!-- 面包屑 -->
                    <el-breadcrumb :separator-icon="ArrowRight" v-if="this.$router.currentRoute.path!='/admin/home'">
                        <el-breadcrumb-item :to="{ path: '/admin/home' }">首页</el-breadcrumb-item>
                        <el-breadcrumb-item >{{$route.name}}</el-breadcrumb-item>
                        <!-- <el-breadcrumb-item>{{this.$router.currentRoute.name}}</el-breadcrumb-item> -->
                    </el-breadcrumb>
                    <div class="homeWelcome" v-if="$route.path=='/admin/home'">
                        <h1>游戏推荐系统</h1>
    ...
    export default {
        ...
        computed:{
            ...
            routeList(){
                ...
                return this.$router.options.routes.filter((_,index) => _.hidden===false).filter((_,index) => _.path.charAt(1)=='a')
            },
        },
        methods:{
