<template>
  ...
  export default {
    ...
    methods:{
      ...
      async initType(){
        const _this = this
        let resp = await this.getRequest('/type/getTypeByPage?current=' + this.currentPage + '&size=' + this.pagesize)
        //console.log(resp)
        _this.typeData = resp.data.records
      ...
      async handleEdit(index, row) {
        ...
        let resp = await this.getRequest('/type/getTypeById?id=' + row.id)
            console.log(resp.data)
            _this.type_edit = resp.data
      },
      //更新分类
      updateType(){
        const _this = this 
      ...
      async search_name(){
         const _this = this
         let resp = await this.getRequest('/type/getTypeByName?name=' + this.input_name)
           console.log(resp)
           if(_this.input_name == ''){
             _this.initTag();
           }else{
