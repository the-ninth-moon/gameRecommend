          ...
          <el-table
              ...
              <template #default=scope>
                  ...
                  <div style="margin-top: 10px;">
                      ...
                      <el-button v-if="!scope.row.processed" style="float: right; margin-right: 10px;" size="mini" @click="processBlog(scope.row.id)">批准发布</el-button>
                      <el-button v-if="scope.row.processed" style="float: right; margin-right: 10px;" size="mini" @click="processBlog(scope.row.id)">打回审核</el-button>
    ...
    //组件的index
      ...
      initBlogs(){
        ...
        if(this.t2index == "1"){ //待审核
          baseurl +=' &processed=0&is_delete=0'
        }
