...
public class FastCodeGenerator {
    ...
    // 基础信息配置
    // 数据库连接字符
    private static final String URL = "jdbc:mysql://47.98.41.200:3306/gamerec?useSSL=false";
    // 数据库用户名
    private static final String USERNAME = "root";
    // 数据库密码
    private static final String PASSWORD = "@text2SQL";
...
//    private static final String parentPackageName = "com.cxhit.mybatisplus.generator";
    private static final String parentPackageName = "com.example.blog";
